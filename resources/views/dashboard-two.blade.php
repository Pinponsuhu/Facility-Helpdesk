        ...
        <main class="w-full h-full overflow-y-scroll px-6">
                ...
                <section class="px-10 py-12 text-gray-900">
                    ...
                    <div class="flex gap-x-4 mt-4">
                        <div class="bg-green-500 w-80 shadow-sm hover:shadow-md text-white rounded-md px-8 py-8">
                            <h1 class="text-6xl font-bold">{{ $active_count }}</h1>
                            <p class="text-xl mt-2">Active Request</p>
                        </div>
                        <div class="bg-red-500 w-80 shadow-sm hover:shadow-md text-white rounded-md px-8 py-8">
                            <h1 class="text-6xl font-bold">{{ $cls_count }}</h1>
                            <p class="text-xl mt-2">Closed Request</p>
                        </div>
                    </div>
                   </div>
                </section>
