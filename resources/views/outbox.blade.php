    ...
    <body class="antialiased h-screen bg-gray-50 flex text-gray-900">
        <nav class="bg-green-500 text-white w-28 h-screen">
                ...
                <ul class="flex flex-col mt-12 gap-y-5">
                    ...
                    <li class="mb-4 py-3 text-white hover:bg-white hover:text-green-500 w-full"><a href="" class="flex flex-col gap-y-2 items-center justify-center"><i class="fa fa-power-off fa-2x"></i><span class="text-md block text-center font-bold">Logout</span></a></li>
                </ul>
        </nav>
        <main class="w-full h-full overflow-y-scroll px-6">
                ...
                <section class="px-10 py-12 text-gray-900">
                    <div class="flex justify-between items-center mb-4">
                        <h1 class="text-2xl font-bold">All Active Request</h1>
                        <span onclick="openReq()" class="bg-green-500 py-3 px-8 rounded-md font-bold text-lg cursor-pointer text-white flex gap-x-1 items-center">New request <i class="fa fa-plus"></i></span>
                    </div>
                    <hr>
                    <div class="mt-6">
                       @foreach ($reqs as $req)
