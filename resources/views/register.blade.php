    ...
    <body class="antialiased bg-gray-50 text-gray-900">
        <header class="py-4 w-full flex justify-between px-8 bg-white ">
            ...
            <div class="flex gap-x-9 items-center">
                ...
                <a href="" class="text-lg py-3 px-7 font-bold bg-green-500 rounded-md text-white font-medium">Sign in</a>
            </div>
        </header>
        <main>
            <div class="px-12">
                <h1 class="text-4xl mt-4 px-12 md:px-36 mb-1 font-extrabold">Sign Up</h1>
                <p class="text-lg  px-12 md:px-36 text-gray-600 mt-1">Already have an account? <a href="/login" class="text-green-500 underline">Sign In</a></p>
