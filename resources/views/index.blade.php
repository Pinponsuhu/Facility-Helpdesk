...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased bg-gray-50 text-gray-900">
        ...
        <main>
            ...
            <h1 class="font-black text-7xl text-center mt-5">How can we help you?</h1>
            <p class="text-lg text-center px-12 md:px-36 text-gray-600 mt-2">Through this platform to get trusted information(Prices and availability date) about the rental of Lagos State University(LASU) facilities</p>
            <div class="px-12">
                <h1 class="text-4xl mt-4 text-center mb-6 font-extrabold">Facilities</h1>
                <div class="grid-cols-3 grid gap-x-8 mb-20">
                    <div class="bg-white hover:shadow-md p-6">
                        <img src="{{ asset('img/main.jpeg') }}" class="h-80 w-full" alt="">
                        <h1 class="text-xl font-bold mt-2.5"><b>Hall Name: </b> Main Auditorium</h1>
                        <p class="text-md"><b>Capacity: </b> 1500</p>
                </div>
                    <div class="bg-white hover:shadow-md p-6">
                        <img src="{{ asset('img/mba.jpeg') }}" class="h-80 w-full" alt="">
                        <h1 class="text-xl font-bold mt-2.5"><b>Hall Name: </b> MBA Hall</h1>
                        <p class="text-md"><b>Capacity: </b> 800</p>
                </div>
                    <div class="bg-white hover:shadow-md p-6">
                        <img src="{{ asset('img/makan.jpeg') }}" class="h-80 w-full" alt="">
